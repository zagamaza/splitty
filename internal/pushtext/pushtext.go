...
var texts = map[string]map[string]string{
	...
	DebtReminderMany: {
		...
		"ja":      "%[2]d つのグループで %[1]s の借りがあります",
		"zh-Hans": "你在 %[2]d 个群组中欠 %[1]s",
		"ko":      "%[2]d개 그룹에서 %[1]s을(를) 갚아야 합니다",
	...
	InviteReturn: {
		...
		"ja":      "%s さんがグループに戻るよう招待しています",
		"zh-Hans": "%s 邀请你回到群组",
		"ko":      "%s 님이 그룹으로 다시 초대했습니다",
