...
const (
	...
	editSumPayerOperation    api.Action = "edit_sum_payer_operation"
	setSumPayerOperation     api.Action = "set_sum_payer_operation"
	saveSumPayerOperation    api.Action = "save_sum_payer_operation"
