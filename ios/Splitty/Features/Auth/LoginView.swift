...
///
/// Перенос приветствия вперёд их НЕ отменяет, хотя соблазн был. Приветствие
/// пропускаемо с любой страницы, и пропустивший приходит сюда, не узнав о
/// продукте ничего: экран входа обязан держаться сам по себе, а не в расчёте
/// на то, что предыдущий экран дочитали.
