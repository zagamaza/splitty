...
///
/// Пункт остался один, и это следствие переноса приветствия. Раньше экран
/// входа был ПЕРВЫМ, и три пункта были единственным, что человек успевал
/// узнать о продукте. Теперь перед ним лежат четыре страницы с арифметикой, и
/// «общий счёт на всех» с «платите один раз» они объясняют подробнее, чем
/// строка списка, — повторять их значит обещать дважды.
///
/// Единственное, чего приветствие НЕ снимает, — страх «оно спишет деньги?».
/// Ответ на него обязан стоять там, где человека просят войти.
